                ...
                for client_type, future_index_long, future_index_short, future_stock_long, future_stock_short, option_index_call_long, option_index_put_long, option_index_call_short, option_index_put_short, option_stock_call_long, option_stock_put_long, option_stock_call_short, optoin_stock_put_short, total_long_contracts, total_short_contracts in bhavcopy.read_participant_oi():
                    try:
                        if client_type == 'Client':
                            cursor.execute('INSERT INTO OI_CLIENT (FUTURE_INDEX_LONG, FUTURE_INDEX_SHORT, FUTURE_STOCK_LONG, FUTURE_STOCK_SHORT, OPTION_INDEX_CALL_LONG, OPTION_INDEX_PUT_LONG, OPTION_INDEX_CALL_SHORT, OPTION_INDEX_PUT_SHORT, OPTION_STOCK_CALL_LONG, OPTION_STOCK_PUT_LONG, OPTION_STOCK_CALL_SHORT, OPTION_STOCK_PUT_SHORT, TOTAL_LONG_CONTRACTS, TOTAL_SHORT_CONTRACTS, TRADE_DATE) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (
                                future_index_long, future_index_short, future_stock_long, future_stock_short, option_index_call_long, option_index_put_long, option_index_call_short, option_index_put_short, option_stock_call_long, option_stock_put_long, option_stock_call_short, optoin_stock_put_short, total_long_contracts, total_short_contracts, bhavcopy.date.strftime('%Y-%m-%d')))
                        if client_type == 'DII':
                            cursor.execute('INSERT INTO OI_DII (FUTURE_INDEX_LONG, FUTURE_INDEX_SHORT, FUTURE_STOCK_LONG, FUTURE_STOCK_SHORT, OPTION_INDEX_CALL_LONG, OPTION_INDEX_PUT_LONG, OPTION_INDEX_CALL_SHORT, OPTION_INDEX_PUT_SHORT, OPTION_STOCK_CALL_LONG, OPTION_STOCK_PUT_LONG, OPTION_STOCK_CALL_SHORT, OPTION_STOCK_PUT_SHORT, TOTAL_LONG_CONTRACTS, TOTAL_SHORT_CONTRACTS, TRADE_DATE) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (
                                future_index_long, future_index_short, future_stock_long, future_stock_short, option_index_call_long, option_index_put_long, option_index_call_short, option_index_put_short, option_stock_call_long, option_stock_put_long, option_stock_call_short, optoin_stock_put_short, total_long_contracts, total_short_contracts, bhavcopy.date.strftime('%Y-%m-%d')))
                        if client_type == 'FII':
                            cursor.execute('INSERT INTO OI_FII (FUTURE_INDEX_LONG, FUTURE_INDEX_SHORT, FUTURE_STOCK_LONG, FUTURE_STOCK_SHORT, OPTION_INDEX_CALL_LONG, OPTION_INDEX_PUT_LONG, OPTION_INDEX_CALL_SHORT, OPTION_INDEX_PUT_SHORT, OPTION_STOCK_CALL_LONG, OPTION_STOCK_PUT_LONG, OPTION_STOCK_CALL_SHORT, OPTION_STOCK_PUT_SHORT, TOTAL_LONG_CONTRACTS, TOTAL_SHORT_CONTRACTS, TRADE_DATE) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (
                                future_index_long, future_index_short, future_stock_long, future_stock_short, option_index_call_long, option_index_put_long, option_index_call_short, option_index_put_short, option_stock_call_long, option_stock_put_long, option_stock_call_short, optoin_stock_put_short, total_long_contracts, total_short_contracts, bhavcopy.date.strftime('%Y-%m-%d')))
                        if client_type == 'Pro':
                            cursor.execute('INSERT INTO OI_PRO (FUTURE_INDEX_LONG, FUTURE_INDEX_SHORT, FUTURE_STOCK_LONG, FUTURE_STOCK_SHORT, OPTION_INDEX_CALL_LONG, OPTION_INDEX_PUT_LONG, OPTION_INDEX_CALL_SHORT, OPTION_INDEX_PUT_SHORT, OPTION_STOCK_CALL_LONG, OPTION_STOCK_PUT_LONG, OPTION_STOCK_CALL_SHORT, OPTION_STOCK_PUT_SHORT, TOTAL_LONG_CONTRACTS, TOTAL_SHORT_CONTRACTS, TRADE_DATE) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', (
                                future_index_long, future_index_short, future_stock_long, future_stock_short, option_index_call_long, option_index_put_long, option_index_call_short, option_index_put_short, option_stock_call_long, option_stock_put_long, option_stock_call_short, optoin_stock_put_short, total_long_contracts, total_short_contracts, bhavcopy.date.strftime('%Y-%m-%d')))
                    except sqlite3.IntegrityError as e:
                        if client_type == 'Client':
                            cursor.execute('UPDATE OI_CLIENT SET FUTURE_INDEX_LONG=?, FUTURE_INDEX_SHORT=?, FUTURE_STOCK_LONG=?, FUTURE_STOCK_SHORT=?, OPTION_INDEX_CALL_LONG=?, OPTION_INDEX_PUT_LONG=?, OPTION_INDEX_CALL_SHORT=?, OPTION_INDEX_PUT_SHORT=?, OPTION_STOCK_CALL_LONG=?, OPTION_STOCK_PUT_LONG=?, OPTION_STOCK_CALL_SHORT=?, OPTION_STOCK_PUT_SHORT=?, TOTAL_LONG_CONTRACTS=?, TOTAL_SHORT_CONTRACTS=? WHERE TRADE_DATE=?', (
                                future_index_long, future_index_short, future_stock_long, future_stock_short, option_index_call_long, option_index_put_long, option_index_call_short, option_index_put_short, option_stock_call_long, option_stock_put_long, option_stock_call_short, optoin_stock_put_short, total_long_contracts, total_short_contracts, bhavcopy.date.strftime('%Y-%m-%d')))
                        if client_type == 'DII':
                            cursor.execute('UPDATE OI_DII SET FUTURE_INDEX_LONG=?, FUTURE_INDEX_SHORT=?, FUTURE_STOCK_LONG=?, FUTURE_STOCK_SHORT=?, OPTION_INDEX_CALL_LONG=?, OPTION_INDEX_PUT_LONG=?, OPTION_INDEX_CALL_SHORT=?, OPTION_INDEX_PUT_SHORT=?, OPTION_STOCK_CALL_LONG=?, OPTION_STOCK_PUT_LONG=?, OPTION_STOCK_CALL_SHORT=?, OPTION_STOCK_PUT_SHORT=?, TOTAL_LONG_CONTRACTS=?, TOTAL_SHORT_CONTRACTS=? WHERE TRADE_DATE=?', (
                                future_index_long, future_index_short, future_stock_long, future_stock_short, option_index_call_long, option_index_put_long, option_index_call_short, option_index_put_short, option_stock_call_long, option_stock_put_long, option_stock_call_short, optoin_stock_put_short, total_long_contracts, total_short_contracts, bhavcopy.date.strftime('%Y-%m-%d')))
                        if client_type == 'FII':
                            cursor.execute('UPDATE OI_FII SET FUTURE_INDEX_LONG=?, FUTURE_INDEX_SHORT=?, FUTURE_STOCK_LONG=?, FUTURE_STOCK_SHORT=?, OPTION_INDEX_CALL_LONG=?, OPTION_INDEX_PUT_LONG=?, OPTION_INDEX_CALL_SHORT=?, OPTION_INDEX_PUT_SHORT=?, OPTION_STOCK_CALL_LONG=?, OPTION_STOCK_PUT_LONG=?, OPTION_STOCK_CALL_SHORT=?, OPTION_STOCK_PUT_SHORT=?, TOTAL_LONG_CONTRACTS=?, TOTAL_SHORT_CONTRACTS=? WHERE TRADE_DATE=?', (
                                future_index_long, future_index_short, future_stock_long, future_stock_short, option_index_call_long, option_index_put_long, option_index_call_short, option_index_put_short, option_stock_call_long, option_stock_put_long, option_stock_call_short, optoin_stock_put_short, total_long_contracts, total_short_contracts, bhavcopy.date.strftime('%Y-%m-%d')))
                        if client_type == 'Pro':
                            cursor.execute('UPDATE OI_PRO SET FUTURE_INDEX_LONG=?, FUTURE_INDEX_SHORT=?, FUTURE_STOCK_LONG=?, FUTURE_STOCK_SHORT=?, OPTION_INDEX_CALL_LONG=?, OPTION_INDEX_PUT_LONG=?, OPTION_INDEX_CALL_SHORT=?, OPTION_INDEX_PUT_SHORT=?, OPTION_STOCK_CALL_LONG=?, OPTION_STOCK_PUT_LONG=?, OPTION_STOCK_CALL_SHORT=?, OPTION_STOCK_PUT_SHORT=?, TOTAL_LONG_CONTRACTS=?, TOTAL_SHORT_CONTRACTS=? WHERE TRADE_DATE=?', (
                                future_index_long, future_index_short, future_stock_long, future_stock_short, option_index_call_long, option_index_put_long, option_index_call_short, option_index_put_short, option_stock_call_long, option_stock_put_long, option_stock_call_short, optoin_stock_put_short, total_long_contracts, total_short_contracts, bhavcopy.date.strftime('%Y-%m-%d')))
